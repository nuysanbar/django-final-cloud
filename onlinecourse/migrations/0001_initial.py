# Generated by Django 3.1.3 on 2023-05-15 05:28
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('text', models.CharField(default='choice content', max_length=600)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(default='question title', max_length=400)),
                ('text', models.CharField(default='question text', max_length=600)),
                ('grade', models.FloatField(verbose_name=5.0)),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='onlinecourse.course')),
            ],
        ),
        migrations.CreateModel(
